...
`,bt=["mon","tue","wed","thu","fri","sat","sun"],$t={mon:"M",tue:"T",wed:"W",thu:"T",fri:"F",sat:"S",sun:"S"},wt={mon:"Mon",tue:"Tue",wed:"Wed",thu:"Thu",fri:"Fri",sat:"Sat",sun:"Sun"},xt=["sun","mon","tue","wed","thu","fri","sat"],kt={clock_style:"digital",mode:"panel",time_format:"12h",show_date:!0,show_day:!0,show_weather:!1,alarms:[],snooze:{duration:5,max_count:3},action_toggles:[],chips:[]};function At(t,e,i){t.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:i}))}function Ct(t,e){let i=t.getHours();const o=t.getMinutes().toString().padStart(2,"0");let s;return"12h"===e&&(s=i>=12?"PM":"AM",i=i%12||12),{hours:i.toString().padStart(2,"0"),minutes:o,period:s}}function St(t,e){if(!t.days_entity)return[];const i=e.states[t.days_entity];return i&&i.state&&"unknown"!==i.state?i.state.split(",").map(t=>t.trim().toLowerCase()).filter(t=>xt.includes(t)):[]}function zt(t){const e=t.split(":").map(Number);return e.length<2||isNaN(e[0])||isNaN(e[1])?null:{hours:e[0],minutes:e[1]}}function Et(t,e,i){const o=new Date,s=o.getDay(),n=60*o.getHours()+o.getMinutes(),a=60*t+e,r=i.length>0?i:[...xt];for(let t=0;t<=7;t++){const e=xt[(s+t)%7];if(!r.includes(e))continue;if(0===t&&a<=n)continue;const i=0===t?a-n:24*t*60-n+a;return{hours:Math.floor(i/60),minutes:i%60}}return null}function Pt(t,e){if(t>=24){return`in ${Math.floor(t/24)}d ${t%24}h`}return t>0?`in ${t}h ${e}m`:`in ${e}m`}let Tt=class extends rt{constructor(){super(...arguments),this.format="12h",this._time=new Date,this._colonVisible=!0}connectedCallback(){super.connectedCallback(),this._startTick()}disconnectedCallback(){super.disconnectedCallback(),this._stopTick()}_startTick(){this._tick(),this._interval=window.setInterval(()=>this._tick(),1e3)}_stopTick(){this._interval&&(clearInterval(this._interval),this._interval=void 0)}_tick(){this._time=new Date,this._colonVisible=!this._colonVisible}render(){const{hours:t,minutes:e,period:i}=Ct(this._time,this.format);return F`
    ...
    `}_renderUnit(t,e,i){const o=this._flipping.has(i);return F`
      <div class="flip-unit">
    ...
    `}};Ut.styles=vt,t([pt({attribute:!1})],Ut.prototype,"alarm",void 0),t([pt({type:Number})],Ut.prototype,"snoozeCount",void 0),t([pt({type:Number})],Ut.prototype,"maxSnoozes",void 0),t([pt()],Ut.prototype,"timeFormat",void 0),t([ut()],Ut.prototype,"_time",void 0),Ut=t([ct("chrono-snooze-dialog")],Ut);let It=class extends rt{setConfig(t){this._config={...kt,...t}}_dispatch(){At(this,"config-changed",{config:{...this._config}})}_valueChanged(t,e){this._config[t]=e,this._config={...this._config},this._dispatch()}_snoozeChanged(t,e){this._config={...this._config,snooze:{...this._config.snooze,[t]:e}},this._dispatch()}_alarmChanged(t,e,i){const o=[...this._config.alarms??[]];o[t]={...o[t],[e]:i},this._config={...this._config,alarms:o},this._dispatch()}_addAlarm(){const t=[...this._config.alarms??[]];t.length>=5||(t.push({time_entity:"",enabled_entity:""}),this._config={...this._config,alarms:t},this._dispatch())}_removeAlarm(t){const e=[...this._config.alarms??[]];e.splice(t,1),this._config={...this._config,alarms:e},this._dispatch()}_toggleChanged(t,e,i){const o=[...this._config.action_toggles??[]];o[t]={...o[t],[e]:i},this._config={...this._config,action_toggles:o},this._dispatch()}_addToggle(){const t=[...this._config.action_toggles??[]];t.push({entity:"",show:!0}),this._config={...this._config,action_toggles:t},this._dispatch()}_removeToggle(t){const e=[...this._config.action_toggles??[]];e.splice(t,1),this._config={...this._config,action_toggles:e},this._dispatch()}_chipChanged(t,e,i){const o=[...this._config.chips??[]];o[t]={...o[t],[e]:i},this._config={...this._config,chips:o},this._dispatch()}_addChip(){const t=[...this._config.chips??[]];t.push({entity:"",show_icon:!0,show_name:!1,show_state:!0}),this._config={...this._config,chips:t},this._dispatch()}_removeChip(t){const e=[...this._config.chips??[]];e.splice(t,1),this._config={...this._config,chips:e},this._dispatch()}_moveChip(t,e){const i=[...this._config.chips??[]],o=t+e;o<0||o>=i.length||([i[t],i[o]]=[i[o],i[t]],this._config={...this._config,chips:i},this._dispatch())}render(){return this.hass&&this._config?F`
      <div class="editor">
        ${this._renderGeneral()}
        ${this._renderChips()}
        ${this._renderAlarms()}
    ...
    `}_getNextAlarmCountdown(){const t=this._config.alarms;if(!t?.length)return"";let e=null;for(const i of t){const t=this.hass.states[i.enabled_entity];if(!t||"on"!==t.state)continue;const o=this.hass.states[i.time_entity];if(!o)continue;const s=zt(o.state);if(!s)continue;const n=St(i,this.hass),a=Et(s.hours,s.minutes,n);if(!a)continue;const r=60*a.hours+a.minutes;(!e||r<60*e.hours+e.minutes)&&(e=a)}return e?Pt(e.hours,e.minutes):""}_toggleAlarmsPanel(){this._showAlarmsPanel=!this._showAlarmsPanel}_renderTopBar(){const t=this._config.alarms,e=t&&t.length>0,i=e?this._getNextAlarmCountdown():"";return F`
      <div class="top-bar">
    ...
    `}_renderChips(){const t=this._config.chips;return t?.length?F`
      <div class="chips-section">
        ${t.map(t=>{const e=this.hass.states[t.entity];if(!e)return V;const i=e.attributes.friendly_name??t.entity,o=t.icon??e.attributes.icon??"",s=t.name??i,n=!1!==t.show_icon,a=!1!==t.show_name,r=!1!==t.show_state,l="on"===e.state?t.color_on||"":t.color_off||"";return F`
            <div class="chip" style=${l?`background: ${l}; color: #fff;`:""}>
              ${n&&o?F`<ha-icon icon=${o}></ha-icon>`:V}
              ${a?F`<span class="chip-name">${s}</span>`:V}
    ...
    `}_renderInfo(){const t=this._config,e=new Date,i=[];if(t.show_day){const t=e.toLocaleDateString(void 0,{weekday:"long"});i.push(F`<span class="day-name">${t}</span>`)}if(t.show_date){i.length&&i.push(F`<span class="separator"></span>`);const t=e.toLocaleDateString(void 0,{month:"long",day:"numeric",year:"numeric"});i.push(F`<span class="date-text">${t}</span>`)}if(t.show_weather&&t.weather_entity){const e=this.hass.states[t.weather_entity];if(e){i.length&&i.push(F`<span class="separator"></span>`);const t=e.attributes.temperature??"",o=e.attributes.temperature_unit??"",s=e.state??"",n=Nt[s]??"mdi:weather-cloudy";i.push(F`
      ...
      <div class="overlay" @click=${this._toggleAlarmsPanel}>
        <div class="dialog-card alarms-panel" @click=${t=>t.stopPropagation()}>
          ...
          <div class="alarms-list">
            ${t.map((t,i)=>{const o=this.hass.states[t.time_entity],s=this.hass.states[t.enabled_entity],n="on"===s?.state,a=o?function(t,e){const i=zt(t);if(!i)return"--:--";let{hours:o}=i;const s=i.minutes.toString().padStart(2,"0");if("12h"===e){const t=o>=12?"PM":"AM";return o=o%12||12,`${o}:${s} ${t}`}return`${o.toString().padStart(2,"0")}:${s}`}(o.state,e):"--:--",r=St(t,this.hass),l=function(t){if(0===t.length)return"Every day";if(7===t.length)return"Every day";if(5===t.length&&["mon","tue","wed","thu","fri"].every(e=>t.includes(e)))return"Weekdays";if(2===t.length&&["sat","sun"].every(e=>t.includes(e)))return"Weekends";const e={mon:"Mo",tue:"Tu",wed:"We",thu:"Th",fri:"Fr",sat:"Sa",sun:"Su"};return t.map(t=>e[t]).join(", ")}(r),c=t.name||`Alarm ${i+1}`;let d="";if(n&&o){const t=zt(o.state);if(t){const e=Et(t.hours,t.minutes,r);e&&(d=Pt(e.hours,e.minutes))}}return F`
                <div
    ...
    `}_renderToggles(){const t=this._config.action_toggles;return t?.length?F`
      <div class="toggles-section">
        ${t.filter(t=>!1!==t.show).map(t=>{const e=this.hass.states[t.entity];if(!e)return V;const i="on"===e.state,o=t.name??e.attributes.friendly_name??t.entity,s=!1!==t.show_icon,n=!1!==t.show_name;return F`
              <div class="toggle-item">
                ${s&&t.icon?F`<ha-icon icon=${t.icon}></ha-icon>`:V}
                ${n?F`<span>${o}</span>`:V}
                <ha-switch
                  .checked=${i}
    ...
    `}_renderSnoozeDialog(){return!this._showSnoozeDialog||this._activeAlarmIndex<0||!this._config.alarms[this._activeAlarmIndex]?V:F`
      ...
      ></chrono-snooze-dialog>
    `}};Ot.styles=mt,t([pt({attribute:!1})],Ot.prototype,"hass",void 0),t([ut()],Ot.prototype,"_config",void 0),t([ut()],Ot.prototype,"_showAlarmDialog",void 0),t([ut()],Ot.prototype,"_editingAlarmIndex",void 0),t([ut()],Ot.prototype,"_showSnoozeDialog",void 0),t([ut()],Ot.prototype,"_activeAlarmIndex",void 0),t([ut()],Ot.prototype,"_snoozeCount",void 0),t([ut()],Ot.prototype,"_showAlarmsPanel",void 0),Ot=t([ct("chrono-alarm-card")],Ot),window.customCards=window.customCards||[],window.customCards.push({type:"chrono-alarm-card",name:"Chrono Alarm Card",description:"A clock and multi-alarm card for Home Assistant",preview:!0});export{Ot as ChronoAlarmCard};
