...
`,bt=["mon","tue","wed","thu","fri","sat","sun"],$t={mon:"M",tue:"T",wed:"W",thu:"T",fri:"F",sat:"S",sun:"S"},wt={mon:"Mon",tue:"Tue",wed:"Wed",thu:"Thu",fri:"Fri",sat:"Sat",sun:"Sun"},xt=["sun","mon","tue","wed","thu","fri","sat"],At={clock_style:"digital",mode:"panel",time_format:"12h",show_date:!0,show_day:!0,show_weather:!1,alarms:[],snooze:{duration:5,max_count:3},action_toggles:[]};function kt(t,e,i){t.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:i}))}function St(t,e){let i=t.getHours();const s=t.getMinutes().toString().padStart(2,"0");let o;return"12h"===e&&(o=i>=12?"PM":"AM",i=i%12||12),{hours:i.toString().padStart(2,"0"),minutes:s,period:o}}function Ct(t,e){if(!t.days_entity)return[];const i=e.states[t.days_entity];return i&&i.state&&"unknown"!==i.state?i.state.split(",").map(t=>t.trim().toLowerCase()).filter(t=>xt.includes(t)):[]}function zt(t){const e=t.split(":").map(Number);return e.length<2||isNaN(e[0])||isNaN(e[1])?null:{hours:e[0],minutes:e[1]}}let Et=class extends rt{constructor(){super(...arguments),this.format="12h",this._time=new Date,this._colonVisible=!0}connectedCallback(){super.connectedCallback(),this._startTick()}disconnectedCallback(){super.disconnectedCallback(),this._stopTick()}_startTick(){this._tick(),this._interval=window.setInterval(()=>this._tick(),1e3)}_stopTick(){this._interval&&(clearInterval(this._interval),this._interval=void 0)}_tick(){this._time=new Date,this._colonVisible=!this._colonVisible}render(){const{hours:t,minutes:e,period:i}=St(this._time,this.format),s=this._colonVisible?":":" ";return F`
      <div class="digital-clock">
        <span class="time-digits">${t}${s}${e}</span>
        ${i?F`<span class="period">${i}</span>`:B}
      </div>
    `}};Et.styles=gt,t([pt()],Et.prototype,"format",void 0),t([ut()],Et.prototype,"_time",void 0),t([ut()],Et.prototype,"_colonVisible",void 0),Et=t([ct("chrono-digital-clock")],Et);let Tt=class extends rt{constructor(){super(...arguments),this.format="12h",this._time=new Date,this._digits="0000",this._prevDigits="0000",this._flipping=new Set,this._period=""}connectedCallback(){super.connectedCallback();const{hours:t,minutes:e,period:i}=St(new Date,this.format);this._digits=`${t}${e}`,this._prevDigits=this._digits,this._period=i??"",this._startTick()}disconnectedCallback(){super.disconnectedCallback(),this._stopTick()}_startTick(){this._interval=window.setInterval(()=>this._tick(),1e3)}_stopTick(){this._interval&&clearInterval(this._interval),this._animTimeout&&clearTimeout(this._animTimeout)}_tick(){this._time=new Date;const{hours:t,minutes:e,period:i}=St(this._time,this.format),s=`${t}${e}`;if(this._period=i??"",s===this._digits)return;const o=new Set;for(let t=0;t<s.length;t++)s[t]!==this._digits[t]&&o.add(t);this._prevDigits=this._digits,this._digits=s,this._flipping=o,this._animTimeout&&clearTimeout(this._animTimeout),this._animTimeout=window.setTimeout(()=>{this._flipping=new Set},650)}render(){const t=this._digits,e=this._prevDigits;return F`
      <div class="flip-clock">
        ...
        ${this._period?F`<span class="flip-period">${this._period}</span>`:B}
      </div>
    ...
    `}};Tt.styles=ft,t([pt()],Tt.prototype,"format",void 0),t([ut()],Tt.prototype,"_time",void 0),t([ut()],Tt.prototype,"_digits",void 0),t([ut()],Tt.prototype,"_prevDigits",void 0),t([ut()],Tt.prototype,"_flipping",void 0),t([ut()],Tt.prototype,"_period",void 0),Tt=t([ct("chrono-flip-clock")],Tt);let Dt=class extends rt{constructor(){super(...arguments),this.alarmIndex=0,this._hours=0,this._minutes=0,this._days=new Set,this._initialised=!1}willUpdate(){!this._initialised&&this.hass&&this.alarm&&(this._loadFromEntity(),this._initialised=!0)}_loadFromEntity(){const t=this.hass.states[this.alarm.time_entity];if(t){const e=zt(t.state);e&&(this._hours=e.hours,this._minutes=e.minutes)}const e=Ct(this.alarm,this.hass);this._days=new Set(e)}_adjustHours(t){this._hours=(this._hours+t+24)%24}_adjustMinutes(t){this._minutes=(this._minutes+t+60)%60}_toggleDay(t){const e=new Set(this._days);e.has(t)?e.delete(t):e.add(t),this._days=e}async _save(){const t=`${this._hours.toString().padStart(2,"0")}:${this._minutes.toString().padStart(2,"0")}:00`;try{if(await this.hass.callService("input_datetime","set_datetime",{entity_id:this.alarm.time_entity,time:t}),this.alarm.days_entity){const t=bt.filter(t=>this._days.has(t)).join(",");await this.hass.callService("input_text","set_value",{entity_id:this.alarm.days_entity,value:t})}}catch(t){console.error("Chrono Alarm Card: failed to save alarm",t)}this._close()}_close(){this._initialised=!1,kt(this,"alarm-dialog-close")}render(){const t=this._hours.toString().padStart(2,"0"),e=this._minutes.toString().padStart(2,"0"),i=this.alarm?.name||`Alarm ${this.alarmIndex+1}`;return F`
    ...
    `}};Dt.styles=[mt,_t],t([pt({attribute:!1})],Dt.prototype,"hass",void 0),t([pt({attribute:!1})],Dt.prototype,"alarm",void 0),t([pt({type:Number})],Dt.prototype,"alarmIndex",void 0),t([ut()],Dt.prototype,"_hours",void 0),t([ut()],Dt.prototype,"_minutes",void 0),t([ut()],Dt.prototype,"_days",void 0),t([ut()],Dt.prototype,"_initialised",void 0),Dt=t([ct("chrono-alarm-dialog")],Dt);let Pt=class extends rt{constructor(){super(...arguments),this.snoozeCount=0,this.maxSnoozes=3,this.timeFormat="12h",this._time=new Date}connectedCallback(){super.connectedCallback(),this._interval=window.setInterval(()=>{this._time=new Date},1e3)}disconnectedCallback(){super.disconnectedCallback(),this._interval&&clearInterval(this._interval)}_snooze(){kt(this,"alarm-snooze")}_dismiss(){kt(this,"alarm-dismiss")}render(){const{hours:t,minutes:e,period:i}=St(this._time,this.timeFormat),s=i?`${t}:${e} ${i}`:`${t}:${e}`,o=this.alarm?.name||"Alarm",n=this.maxSnoozes-this.snoozeCount,a=n>0;return F`
    ...
    `}};Pt.styles=vt,t([pt({attribute:!1})],Pt.prototype,"alarm",void 0),t([pt({type:Number})],Pt.prototype,"snoozeCount",void 0),t([pt({type:Number})],Pt.prototype,"maxSnoozes",void 0),t([pt()],Pt.prototype,"timeFormat",void 0),t([ut()],Pt.prototype,"_time",void 0),Pt=t([ct("chrono-snooze-dialog")],Pt);let Mt=class extends rt{setConfig(t){this._config={...At,...t}}_dispatch(){kt(this,"config-changed",{config:{...this._config}})}_valueChanged(t,e){this._config[t]=e,this._config={...this._config},this._dispatch()}_snoozeChanged(t,e){this._config={...this._config,snooze:{...this._config.snooze,[t]:e}},this._dispatch()}_alarmChanged(t,e,i){const s=[...this._config.alarms??[]];s[t]={...s[t],[e]:i},this._config={...this._config,alarms:s},this._dispatch()}_addAlarm(){const t=[...this._config.alarms??[]];t.length>=5||(t.push({time_entity:"",enabled_entity:""}),this._config={...this._config,alarms:t},this._dispatch())}_removeAlarm(t){const e=[...this._config.alarms??[]];e.splice(t,1),this._config={...this._config,alarms:e},this._dispatch()}_toggleChanged(t,e,i){const s=[...this._config.action_toggles??[]];s[t]={...s[t],[e]:i},this._config={...this._config,action_toggles:s},this._dispatch()}_addToggle(){const t=[...this._config.action_toggles??[]];t.push({entity:"",show:!0}),this._config={...this._config,action_toggles:t},this._dispatch()}_removeToggle(t){const e=[...this._config.action_toggles??[]];e.splice(t,1),this._config={...this._config,action_toggles:e},this._dispatch()}render(){return this.hass&&this._config?F`
      <div class="editor">
        ${this._renderGeneral()}
        ${this._renderAlarms()}
        ${this._renderSnooze()}
    ...
    `:B}_renderGeneral(){const t=this._config;return F`
    ...
    `}_renderSnooze(){const t=this._config.snooze??At.snooze;return F`
      <div class="editor-section">
    ...
    `}_renderClock(){const t=this._config.clock_style??"digital",e=this._config.time_format??"12h";return"flip"===t?F`
    ...
    `}_renderInfo(){const t=this._config,e=new Date,i=[];if(t.show_day){const t=e.toLocaleDateString(void 0,{weekday:"long"});i.push(F`<span class="day-name">${t}</span>`)}if(t.show_date){i.length&&i.push(F`<span class="separator"></span>`);const t=e.toLocaleDateString(void 0,{month:"long",day:"numeric",year:"numeric"});i.push(F`<span class="date-text">${t}</span>`)}if(t.show_weather&&t.weather_entity){const e=this.hass.states[t.weather_entity];if(e){i.length&&i.push(F`<span class="separator"></span>`);const t=e.attributes.temperature??"",s=e.attributes.temperature_unit??"",o=e.state??"",n=Ut[o]??"mdi:weather-cloudy";i.push(F`
          <span class="weather-info">
            <ha-icon icon=${n}></ha-icon>
            ${t}${s}
          </span>
        `)}}return i.length?F`<div class="info-section">${i}</div>`:B}_renderAlarms(){const t=this._config.alarms;if(!t?.length)return B;const e=this._config.time_format??"12h";return F`
      <div class="alarms-section">
        <div class="alarms-header">Alarms</div>
        ${t.map((t,i)=>{const s=this.hass.states[t.time_entity],o=this.hass.states[t.enabled_entity],n="on"===o?.state,a=s?function(t,e){const i=zt(t);if(!i)return"--:--";let{hours:s}=i;const o=i.minutes.toString().padStart(2,"0");if("12h"===e){const t=s>=12?"PM":"AM";return s=s%12||12,`${s}:${o} ${t}`}return`${s.toString().padStart(2,"0")}:${o}`}(s.state,e):"--:--",r=function(t){if(0===t.length)return"Every day";if(7===t.length)return"Every day";if(5===t.length&&["mon","tue","wed","thu","fri"].every(e=>t.includes(e)))return"Weekdays";if(2===t.length&&["sat","sun"].every(e=>t.includes(e)))return"Weekends";const e={mon:"Mo",tue:"Tu",wed:"We",thu:"Th",fri:"Fr",sat:"Sa",sun:"Su"};return t.map(t=>e[t]).join(", ")}(Ct(t,this.hass)),l=t.name||`Alarm ${i+1}`;return F`
            <div
              class="alarm-item ${n?"":"disabled"}"
              @click=${()=>this._openAlarmDialog(i)}
            >
              <span class="alarm-name">${l}</span>
              <span class="alarm-time">${a}</span>
              <span class="alarm-days">${r}</span>
    ...
    `}_renderToggles(){const t=this._config.action_toggles;return t?.length?F`
      <div class="toggles-section">
        ${t.filter(t=>!1!==t.show).map(t=>{const e=this.hass.states[t.entity];if(!e)return B;const i="on"===e.state,s=t.name??e.attributes.friendly_name??t.entity;return F`
              <div class="toggle-item">
                ${t.icon?F`<ha-icon icon=${t.icon}></ha-icon>`:B}
                <span>${s}</span>
                <ha-switch
                  .checked=${i}
    ...
    `:B}_renderAlarmDialog(){return!this._showAlarmDialog||this._editingAlarmIndex<0||!this._config.alarms[this._editingAlarmIndex]?B:F`
      <chrono-alarm-dialog
        .hass=${this.hass}
      ...
      ></chrono-alarm-dialog>
    `}_renderSnoozeDialog(){return!this._showSnoozeDialog||this._activeAlarmIndex<0||!this._config.alarms[this._activeAlarmIndex]?B:F`
      ...
      ></chrono-snooze-dialog>
    `}};It.styles=mt,t([pt({attribute:!1})],It.prototype,"hass",void 0),t([ut()],It.prototype,"_config",void 0),t([ut()],It.prototype,"_showAlarmDialog",void 0),t([ut()],It.prototype,"_editingAlarmIndex",void 0),t([ut()],It.prototype,"_showSnoozeDialog",void 0),t([ut()],It.prototype,"_activeAlarmIndex",void 0),t([ut()],It.prototype,"_snoozeCount",void 0),It=t([ct("chrono-alarm-card")],It),window.customCards=window.customCards||[],window.customCards.push({type:"chrono-alarm-card",name:"Chrono Alarm Card",description:"A clock and multi-alarm card for Home Assistant",preview:!0});export{It as ChronoAlarmCard};
