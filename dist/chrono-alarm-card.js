...
`,bt=["mon","tue","wed","thu","fri","sat","sun"],$t={mon:"M",tue:"T",wed:"W",thu:"T",fri:"F",sat:"S",sun:"S"},wt={mon:"Mon",tue:"Tue",wed:"Wed",thu:"Thu",fri:"Fri",sat:"Sat",sun:"Sun"},xt=["sun","mon","tue","wed","thu","fri","sat"],kt={clock_style:"digital",mode:"panel",time_format:"12h",show_date:!0,show_day:!0,show_weather:!1,alarms:[],snooze:{duration:5,max_count:3},action_toggles:[],chips:[]};function At(t,e,i){t.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:i}))}function Ct(t,e){let i=t.getHours();const s=t.getMinutes().toString().padStart(2,"0");let o;return"12h"===e&&(o=i>=12?"PM":"AM",i=i%12||12),{hours:i.toString().padStart(2,"0"),minutes:s,period:o}}function St(t,e){if(!t.days_entity)return[];const i=e.states[t.days_entity];return i&&i.state&&"unknown"!==i.state?i.state.split(",").map(t=>t.trim().toLowerCase()).filter(t=>xt.includes(t)):[]}function zt(t){const e=t.split(":").map(Number);return e.length<2||isNaN(e[0])||isNaN(e[1])?null:{hours:e[0],minutes:e[1]}}let Et=class extends rt{constructor(){super(...arguments),this.format="12h",this._time=new Date,this._colonVisible=!0}connectedCallback(){super.connectedCallback(),this._startTick()}disconnectedCallback(){super.disconnectedCallback(),this._stopTick()}_startTick(){this._tick(),this._interval=window.setInterval(()=>this._tick(),1e3)}_stopTick(){this._interval&&(clearInterval(this._interval),this._interval=void 0)}_tick(){this._time=new Date,this._colonVisible=!this._colonVisible}render(){const{hours:t,minutes:e,period:i}=Ct(this._time,this.format);return F`
    ...
    `}};Pt.styles=vt,t([pt({attribute:!1})],Pt.prototype,"alarm",void 0),t([pt({type:Number})],Pt.prototype,"snoozeCount",void 0),t([pt({type:Number})],Pt.prototype,"maxSnoozes",void 0),t([pt()],Pt.prototype,"timeFormat",void 0),t([ut()],Pt.prototype,"_time",void 0),Pt=t([ct("chrono-snooze-dialog")],Pt);let Mt=class extends rt{setConfig(t){this._config={...kt,...t}}_dispatch(){At(this,"config-changed",{config:{...this._config}})}_valueChanged(t,e){this._config[t]=e,this._config={...this._config},this._dispatch()}_snoozeChanged(t,e){this._config={...this._config,snooze:{...this._config.snooze,[t]:e}},this._dispatch()}_alarmChanged(t,e,i){const s=[...this._config.alarms??[]];s[t]={...s[t],[e]:i},this._config={...this._config,alarms:s},this._dispatch()}_addAlarm(){const t=[...this._config.alarms??[]];t.length>=5||(t.push({time_entity:"",enabled_entity:""}),this._config={...this._config,alarms:t},this._dispatch())}_removeAlarm(t){const e=[...this._config.alarms??[]];e.splice(t,1),this._config={...this._config,alarms:e},this._dispatch()}_toggleChanged(t,e,i){const s=[...this._config.action_toggles??[]];s[t]={...s[t],[e]:i},this._config={...this._config,action_toggles:s},this._dispatch()}_addToggle(){const t=[...this._config.action_toggles??[]];t.push({entity:"",show:!0}),this._config={...this._config,action_toggles:t},this._dispatch()}_removeToggle(t){const e=[...this._config.action_toggles??[]];e.splice(t,1),this._config={...this._config,action_toggles:e},this._dispatch()}_chipChanged(t,e,i){const s=[...this._config.chips??[]];s[t]={...s[t],[e]:i},this._config={...this._config,chips:s},this._dispatch()}_addChip(){const t=[...this._config.chips??[]];t.push({entity:"",show_icon:!0,show_name:!1,show_state:!0}),this._config={...this._config,chips:t},this._dispatch()}_removeChip(t){const e=[...this._config.chips??[]];e.splice(t,1),this._config={...this._config,chips:e},this._dispatch()}render(){return this.hass&&this._config?F`
      <div class="editor">
        ${this._renderGeneral()}
        ${this._renderChips()}
        ${this._renderAlarms()}
    ...
    `:B}_renderChips(){const t=this._config.chips??[];return F`
    ...
    `}_renderChips(){const t=this._config.chips;return t?.length?F`
      <div class="chips-section">
        ${t.map(t=>{const e=this.hass.states[t.entity];if(!e)return B;const i=e.attributes.friendly_name??t.entity,s=t.icon??e.attributes.icon??"",o=t.name??i,n=!1!==t.show_icon,a=!1!==t.show_name,r=!1!==t.show_state;return F`
            <div class="chip">
              ${n&&s?F`<ha-icon icon=${s}></ha-icon>`:B}
              ${a?F`<span class="chip-name">${o}</span>`:B}
              ${r?F`<span class="chip-state">${e.state}</span>`:B}
            </div>
          `})}
      </div>
    `:B}_renderClock(){const t=this._config.clock_style??"digital",e=this._config.time_format??"12h";return"flip"===t?F`
    ...
    `}_renderToggles(){const t=this._config.action_toggles;return t?.length?F`
      <div class="toggles-section">
        ${t.filter(t=>!1!==t.show).map(t=>{const e=this.hass.states[t.entity];if(!e)return B;const i="on"===e.state,s=t.name??e.attributes.friendly_name??t.entity,o=!1!==t.show_icon,n=!1!==t.show_name;return F`
              <div class="toggle-item">
                ${o&&t.icon?F`<ha-icon icon=${t.icon}></ha-icon>`:B}
                ${n?F`<span>${s}</span>`:B}
                <ha-switch
                  .checked=${i}
